...
const Section2 = () => {
    return (
        <div className='max-w-7xl h-[600px] bg-white'>
            <HeadingTitle className='text-black' title={'FIND US NOW'} subtitle='READY FOR WORKOUT'></HeadingTitle>
            <div className='grid xl:grid-cols-3 md:grid-cols-3 grid-cols-2 justify-center w-full mx-auto h-auto xl:max-w-7xl xl:h-[300px] gap-4 my-10'>
           <div className='w-[350px] bg-[#D0FD3E] mx-auto h-[400px]'>
            <img className='relative' src={img1} alt="" />
            <div className='w-[130px] absolute mx-28 -mt-16 rounded-full h-[130px] bg-black'>
