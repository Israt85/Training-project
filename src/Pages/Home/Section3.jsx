...
& FEELING A HEALTHIER"></HeadingTitle>
        ...
        <div className='w-[1140px] h-[1286px] grid grid-cols-2 justify-center mx-auto -mt-80 gap-2'>
           <div className=''>
           <img className='w-[550px] h-[571px]' src={img1} alt="" />
...
<stop offset="1" stop-color="#3B480D"/>
           ...
           <div className=''>
           <img className='w-[550px] h-[571px]' src={img2} alt="" />
           <div className='-mt-64 px-6 text-white'>
...
<stop offset="1" stop-color="#3B480D"/>
           ...
           <div className=''>
           <img className='w-[550px] h-[571px]' src={img3} alt="" />
           <div className='-mt-64 px-6 text-white'>
...
<stop offset="1" stop-color="#3B480D"/>
           ...
           <div className=''>
           <img className='w-[550px] h-[571px]' src={img4} alt="" />
           <div className='-mt-64 px-6 text-white'>
