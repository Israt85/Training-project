...
& FEELING A HEALTHIER"></HeadingTitle>
        ...
        <div className='w-[1140px] h-auto grid lg:grid-cols-2 grid-cols-1 gap-4 justify-center mx-auto -mt-80 '>
           <div className=''>
...
<p className='w-[441px] h-[46px] text-gray-300 my-2'>Get customized workout plans with one-on-one coaching to help you reach your fitness goals safely and effectively.</p>
...
<p className='w-[441px] h-[46px] text-gray-300 my-2'>Experience guided yoga sessions to improve flexibility, balance, and mental well-being, suitable for all skill levels.</p>
<button className='flex gap-2 items-center'>Read More <svg width="28" height="24" viewBox="0 0 28 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<rect width="28" height="24" rx="12" fill="url(#paint0_linear_301_1368)"/>
<path d="M18.0875 11.4492C18.693 11.8203 18.693 12.6992 18.0875 13.0703L11.2125 17.1328C10.5875 17.5039 9.80625 17.0547 9.80625 16.3125V8.1875C9.80625 7.38672 10.6461 7.05469 11.2125 7.38672L18.0875 11.4492Z" fill="white"/>
<defs>
...
<p className='w-[441px] h-[46px] text-gray-300 my-2'>Receive tailored meal plans and expert advice to support healthy eating habits and achieve your wellness goals.</p>
<button className='flex gap-2 items-center'>Read More <svg width="28" height="24" viewBox="0 0 28 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<rect width="28" height="24" rx="12" fill="url(#paint0_linear_301_1368)"/>
<path d="M18.0875 11.4492C18.693 11.8203 18.693 12.6992 18.0875 13.0703L11.2125 17.1328C10.5875 17.5039 9.80625 17.0547 9.80625 16.3125V8.1875C9.80625 7.38672 10.6461 7.05469 11.2125 7.38672L18.0875 11.4492Z" fill="white"/>
<defs>
...
<p className='w-[445px] h-[65px] my-2 text-gray-300'>Access personalized fitness and nutrition coaching from anywhere with our flexible, online programs designed for your lifestyle.</p>
<button className='flex gap-2 items-center'>Read More <svg width="28" height="24" viewBox="0 0 28 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<rect width="28" height="24" rx="12" fill="url(#paint0_linear_301_1368)"/>
<path d="M18.0875 11.4492C18.693 11.8203 18.693 12.6992 18.0875 13.0703L11.2125 17.1328C10.5875 17.5039 9.80625 17.0547 9.80625 16.3125V8.1875C9.80625 7.38672 10.6461 7.05469 11.2125 7.38672L18.0875 11.4492Z" fill="white"/>
<defs>
