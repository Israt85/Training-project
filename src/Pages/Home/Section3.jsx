...
const Section3 = () => {
    return (
        <div className='bg-white'>
            <div className='max-w-8xl my-20 mx-auto h-[471px] lg:h-[571px] py-10 text-white bg-gradient-to-t from-[#3B480D] to-[#D0FD3E]'>
...
<div className='w-full mx-auto h-full'>
<img className='w-80 md:w-[500px] mx-auto rounded-lg h-72 xl:w-[550px] lg:h-[521px]' src={img3} alt="" />
<div className='-mt-64 px-10 text-white'>
...
<div className='w-full mx-auto h-full'>
<img className='w-80 md:w-[500px] mx-auto rounded-lg h-72 xl:w-[550px] lg:h-[521px]' src={img4} alt="" />
<div className='-mt-64 px-10 text-white'>
