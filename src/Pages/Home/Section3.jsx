...
& FEELING A HEALTHIER"></HeadingTitle>
        ...
        <div className='lg:w-[1140px] md:w-[900px]  border my-10 xl:h-[1286px] grid md:grid-cols-2 grid-cols-1 items-center lg:gap-10 justify-center lg:mx-20 mx-4 -mt-96 '>
...
<stop offset="1" stop-color="#3B480D"/>
           ...
           <img className='w-80 md:w-[500px] mx-auto rounded-lg h-72 xl:w-[550px] lg:h-[521px]' src={img2} alt="" />
           <div className='-mt-64 px-10 text-white'>
...
<stop offset="1" stop-color="#3B480D"/>
           ...
           <div className=''>
           <img className='w-80 mx-auto rounded-lg xl:w-[550px] lg:h-[571px]' src={img3} alt="" />
           <div className='-mt-64 px-10 text-white'>
...
<stop offset="1" stop-color="#3B480D"/>
           ...
           <div className=''>
           <img className='w-80 mx-auto rounded-lg xl:w-[550px] lg:h-[591px]' src={img4} alt="" />
           <div className='-mt-64 px-10 text-white'>
