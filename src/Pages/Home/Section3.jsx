...
const Section3 = () => {
    return (
        <div className='bg-white'>
            <div className='max-w-7xl my-20 mx-auto h-[471px] lg:h-[571px] py-10 text-white bg-gradient-to-t from-[#3B480D] to-[#D0FD3E]'>
            <HeadingTitle title={'OUR SERVICES'} subtitle="SOLUTIONS FOR MOVING BETTER       
& FEELING A HEALTHIER"></HeadingTitle>
            
        </div>
        <div className='lg:w-[1140px] my-10 xl:h-[1286px] grid md:grid-cols-2 grid-cols-1 items-center gap-10 justify-center lg:mx-20 mx-4 -mt-96 '>
           <div className='w-full mx-auto h-full'>
           <img className='w-72 mx-auto rounded-lg h-72 xl:w-[550px] lg:h-[571px]' src={img1} alt="" />
           <div className='-mt-64 px-10 text-white'>
           <img className='mt-6' src={sec3logo} alt="" />
<h1 className='my-2 text-3xl font-medium font-teko'>
PERSONAL TRAINING
</h1>
<p className='xl:w-[441px] text-sm lg:h-[46px] w-60 text-gray-300 lg:my-2'>Get customized workout plans with one-on-one coaching to help you reach your fitness goals safely and effectively.</p>
...
<stop offset="1" stop-color="#3B480D"/>
           ...
           <img className='w-72 mx-auto rounded-lg h-72 xl:w-[550px] lg:h-[571px]' src={img2} alt="" />
           <div className='-mt-64 px-10 text-white'>
           <img className='my-4' src={logo2} alt="" />
<h1 className='lg:my-2 text-3xl font-medium font-teko'>
YOGA LESSON
</h1>
<p className='xl:w-[441px] text-sm lg:h-[46px] w-60 text-gray-300 lg:my-2'>Experience guided yoga sessions to improve flexibility, balance, and mental well-being, suitable for all skill levels.</p>
<button className='flex gap-2 mt-1 items-center'>Read More <svg width="28" height="24" viewBox="0 0 28 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<rect width="28" height="24" rx="12" fill="url(#paint0_linear_301_1368)"/>
<path d="M18.0875 11.4492C18.693 11.8203 18.693 12.6992 18.0875 13.0703L11.2125 17.1328C10.5875 17.5039 9.80625 17.0547 9.80625 16.3125V8.1875C9.80625 7.38672 10.6461 7.05469 11.2125 7.38672L18.0875 11.4492Z" fill="white"/>
<defs>
...
<stop offset="1" stop-color="#3B480D"/>
           ...
           <div className=''>
           <img className='w-72 mx-auto rounded-lg xl:w-[550px] lg:h-[571px]' src={img3} alt="" />
           <div className='-mt-64 px-10 text-white'>
...
<p className='xl:w-[441px] text-sm lg:h-[46px] w-60 text-gray-300 lg:my-2'>Receive tailored meal plans and expert advice to support healthy eating habits and achieve your wellness goals.</p>
...
<stop offset="1" stop-color="#3B480D"/>
           ...
           <div className=''>
           <img className='w-72 mx-auto rounded-lg xl:w-[550px] lg:h-[571px]' src={img4} alt="" />
           <div className='-mt-64 px-10 text-white'>
           <img className='my-4' src={logo4} alt="" />
<h1 className='lg:my-2 text-3xl font-medium font-teko'>
ONLINE COACHING
</h1>
<p className='xl:w-[445px] text-sm lg:h-[65px] w-60 lg:my-2 text-gray-300'>Access personalized fitness and nutrition coaching from anywhere with our flexible, online programs designed for your lifestyle.</p>
<button className='flex mt-1 gap-2 items-center'>Read More <svg width="28" height="24" viewBox="0 0 28 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<rect width="28" height="24" rx="12" fill="url(#paint0_linear_301_1368)"/>
<path d="M18.0875 11.4492C18.693 11.8203 18.693 12.6992 18.0875 13.0703L11.2125 17.1328C10.5875 17.5039 9.80625 17.0547 9.80625 16.3125V8.1875C9.80625 7.38672 10.6461 7.05469 11.2125 7.38672L18.0875 11.4492Z" fill="white"/>
<defs>
