...
import serviceleft from '../../assets/footerleft.png'
import serviceright from '../../assets/footerright.png'

const Section3 = () => {
    return (
        <div className='bg-white'>
            <div className='max-w-7xl my-20 mx-auto h-[500px] py-10 text-white bg-gradient-to-t from-[#3B480D] to-[#D0FD3E]'>
                <HeadingTitle title={'OUR SERVICES'} subtitle="SOLUTIONS FOR MOVING BETTER       
& FEELING A HEALTHIER"></HeadingTitle>

            </div>
           
            <div className='max-w-7xl mx-auto grid grid-cols-1 min-h-screen md:grid-cols-2 gap-8 -mt-60 px-4 lg:px-8'>
                <div className='relative w-full mx-auto h-full'>
                    <img className='w-full rounded-lg h-full object-cover' src={img1} alt="" />
...
<img className='w-full h-full rounded-lg object-cover' src={img2} alt="" />
<div className='absolute rounded-lg inset-0 bg-gradient-to-t from-black to-transparent'>
...
<img className='w-full rounded-lg h-full object-cover' src={img3} alt="" />
<div className='absolute rounded-lg inset-0 bg-gradient-to-t from-black to-transparent'>
...
<img className='h-full rounded-lg w-full object-cover' src={img4} alt="" />
<div className='absolute rounded-lg  inset-0 bg-gradient-to-t from-black to-transparent'>
<div className='absolute left-0 right-0 bottom-0 p-6 text-white'>
