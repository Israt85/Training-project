...
const Section2 = () => {
    return (
        <div
  className="hero w-full lg:w-[1440px] h-[982px]"
  style={{
  ...
  <div className="text-white">
    <div className='flex lg:flex-row flex-col justify-between gap-4 tracking-widest'>
        <div className='w-[550px] lg:block hidden'>
      ...
      <div className='flex lg:flex-row gap-2 justify-center lg:justify-evenly lg:text-left my-10 lg:-ml-20 mr-28'>
        <div>
          <div className='my-6'>
