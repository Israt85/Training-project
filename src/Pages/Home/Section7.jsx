...
const Section7 = () => {
    return (
        <div
        className="hero w-full h-[400px] xl:w-[1440px] lg:h-[982px]"
        style={{
        ...
        <div className="text-white">
          <div className='flex flex-col justify-center lg:flex-row lg:justify-between gap-4 lg:tracking-widest'>
            ...
            <h1 className="mb-5 text-xl xl:text-5xl font-teko font-semibold w-[400px]">SEND US A MESSAGE
            & JOIN OUR TEAM</h1>
            </div>
           ...
           <div className='lg:w-[450px] rounded-md mx-2 h-20 lg:h-[130px] bg-white'>
